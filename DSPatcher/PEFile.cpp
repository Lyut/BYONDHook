...
void PEFile::buildImportTable() {
    ...
    int index = addSection((char*)SECTION_IMPORT, oldImportDllsSize + newImportsSize, false);
...
void PEFile::fixReservedData() {
    ...
    int sectionIndex = addSection((char*)SECTION_RESERV, reservedData.Size, false);
